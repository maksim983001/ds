...
group :test do
  ...
  #For integration tests [https://github.com/rails/rails-controller-testing]
...
#Clean up the DB in testing [https://github.com/DatabaseCleaner/database_cleaner]
...
gem 'faker', '~> 3.2'
#Test framework [https://github.com/teamcapybara/capybara]
gem 'capybara', '~> 2.7'
